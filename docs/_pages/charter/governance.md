...
8. Участники собрания должны стремиться действовать рационально для достижения Миссии. 
...
10. Финансово поддерживает деятельность ДАО.
...
4. Любой комитет может сформировать Sub-DAO для распространения своей работы. 
5. Это может назначить или удалить других членов ДАО в или от этих подкомитетов по мере необходимости.
6. Командам членов может быть выделен бюджет токенов или других активов из Казны Комитета в достижении целей ДАО. 
7. Команды непостоянны, и их финансирование требует одобрения от одного или нескольких комитетов или принятия предложения.
...
29. Предложения должны оправдывать издержки на их голосование. 
30. Собственники ДАО имеют доступ к коллективному действию через создание Предложений. 
31. Main DAO с 2/3 голосов может наложить на Предложение вето.  
 Наши цели в Предложениях могут быть корыстны. 
 Поэтому личные цели участника должны быть встраиваемы в ДАО, а именно основное значение будет иметь те Предложения, которые будут двигать нашу Миссию. 
...
12. Владельцы участвуют. 
 Это значит как минимум приняли 1 решение за последний сезон. 
 В противном случае положен штраф.

### Оспорение решения

Optimistic Governance - процесс, при котором решения вступают в силу с задержкой во времени, что позволяет. 
Если решение не оспаривается, то изменение вступает в силу по истечении временной задержки. 
Это позволяет принимать решения гораздо быстрее и принимать стратегические решения.

Суверенный индивид представленное кошельковым адресом, имеет право быть назначенным для рассмотрения споров. 
Таким образом он ненадолго становится Опекуном (Guardian).
Если Опекун вызывается, он должен проголосовать за разрешение или блокировку спорного действия и может быть награжден (получить токены) или наказан (потерять токены), в зависимости от того, проголосовал ли он с большинством (дефолтная интерпретация) или против него. 
Протокол разработан таким образом, чтобы хранители не знали друг друга и не имели контакта, когда они вызываются.

## ПРОЦЕДУРЫ ИЗМЕНЕНИЯ ХАРТИИ
...
9. Поправки в Устав решаются через Общее собрание членов единоличное решение всех 9/10 голосов от всех комитетов. 
10. Поправки в Сетикет решаются через Общее собрание членов большинства 2/3 голосов от всех комитетов. 
...
Каждый владелец GIC DAO будет измерять успех разными способами, но ориентироваться на следующие четыре цели: 

1. Население
Членство вступивших в GIC DAO растет. 

2. Определенная территория
Размеры нашего киберпространства остаются под нашим контролем, в надежности и безопасности.

3. Правительство
Main DAO является органом управления, разрешающая все внешние и внутренние угрозы. 

4. Вступление в отношения
GIC DAO вступает в отношения с другими государствами. 
