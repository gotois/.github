...
Смысл GIC DAO (далее — Мы) обусловлен стремлением к настоящей Справедливости.  
...
### Предоставление общественных и гражданских благ
...
Попадая в интернет, пользователь оставляет цифровую тень, которая становится объектом эксплуатации со стороны недоверенных третьих лиц.
...
Мы стремимся создать платформу, которая позволяет людям взаимодействовать и договариваться без привлечения третьих сторон, таких как суды.
...
## Что Мы производим и зачем это делаем
...
**Сетевой этикет** становится правилами нашей культуры.  
